...
lines = []
with open("Data/weld/2022128_1_weld_004.csv", 'r') as file:
    data = csv.reader(file)
    for entry in data:
        lines.append(entry)


unix_start = 1670517862 * 1000
...
df=openfiles.df_from_path(openfiles.col_to_list(df_meta,'Path_weld'),3-1)
print(df)
...
df.to_csv("Data/weld/2022128_1_weld_004.csv",index=False)
